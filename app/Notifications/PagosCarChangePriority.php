...
class PagosCarChangePriority extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        ...
        return [
            ...
            'title' => 'Pago ',
            'content' => ' por concepto de '. $this->transaccion->expense_type->name . ' vehiculo #'.$vehiculo . ' ha cambiado de prioridad a '.$prioridad
        ];
    }
    ...
    public function toTwilio($notifiable)
    {
       // $message= _lang('Pago ha sido creado'). ' '. _lang('transaccion') . ' #' . $this->transaccion->id;
        ...
        $message= 'Pago  por concepto de '. $this->transaccion->expense_type->name . ' vehiculo #'.$vehiculo . ' ha cambiado de prioridad a '.$prioridad;
