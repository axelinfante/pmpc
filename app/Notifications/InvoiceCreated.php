...
class InvoiceCreated extends Notification
{
    ...
    public function toInfobip($notifiable)
    {
       ...
       $message= _lang('Created New Invoice').' '. _lang('Invoice').'# '.$this->invoice->invoice_number;
    ...
    {
       // $message= _lang('Nueva factura ha sido creada ').' '. _lang('Invoice').'# '.$this->invoice->invoice_number;
       ///$message.= '. Para mas detalle visite: ' . route('invoices.show', $this->invoice->id);
       $message= _lang('Created New Invoice').' '. _lang('Invoice').' #'.$this->invoice->invoice_number;
       $message.= '. Para mas detalle visite: ' . route('invoices.show', $this->invoice->id);
        return [
