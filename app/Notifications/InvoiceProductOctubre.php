...
class InvoiceProductOctubre extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            ...
            'title'   		=> 'Venta de producto de Octubre',
    ...
    public function toInfobip($notifiable)
    {
       ...
       $message= 'Venta de producto de Octubre '.$this->product->id.' '.$this->product->item->item_name;
