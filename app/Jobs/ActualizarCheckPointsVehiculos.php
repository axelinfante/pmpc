...
class ActualizarCheckPointsVehiculos implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            Cars::where('estado_tramite', 'Pendiente')->chunk(100, function ($cars) use ($checkpoints) {
                foreach ($cars as $car) {
