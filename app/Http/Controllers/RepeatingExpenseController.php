...
class RepeatingExpenseController extends Controller
{
	...
	public function get_table_data(){
		...
		return Datatables::eloquent($transactions)
						...
						->addColumn('action', function ($trans) {
							...
							.'<a href="'.action('RepeatingExpenseController@edit', $trans['id']).'" data-title="'._lang('Update Income') .'" class="btn btn-warning btn-xs ajax-modal"><i class="ti-pencil"></i></a>&nbsp;'
							.'<a href="'.action('RepeatingExpenseController@show', $trans['id']).'" data-title="'._lang('View Income') .'" class="btn btn-primary btn-xs ajax-modal"><i class="ti-eye"></i></a>&nbsp;'
							.csrf_field()
    ...
    {	
		...
		if(! $request->ajax()){
           return redirect('repeating_expense')->with('success', _lang('Saved Sucessfully'));
        }else{
    ...
    public function update(Request $request, $id)
    {
		...
		if(! $request->ajax()){
           return redirect('repeating_expense')->with('success', _lang('Updated Sucessfully'));
        }else{
    ...
    public function destroy($id)
    {
        ...
        return redirect('repeating_expense')->with('success',_lang('Removed Sucessfully'));
    }
}
