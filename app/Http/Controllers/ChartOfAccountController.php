...
class ChartOfAccountController extends Controller
{
    ...
    public function index()
    {
        ...
        $chartofaccounts = ChartOfAccount::whereIn('company_id', $company_id)
										  ->orderBy("id","desc")->get();
    ...
    {	
		$validator = Validator::make($request->all(), [
			'name' => 'required|max:50|unique:chart_of_accounts,name',
			'type' => 'required',
		]);
    ...
    {
        $chartofaccount = ChartOfAccount::where("id",$id)->first();
    ...
    {
		$validator = Validator::make($request->all(), [
			'name' => 'required|max:50|unique:chart_of_accounts,name,'.$id,
			'type' => 'required',
		]);
