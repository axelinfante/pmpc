...
@section('js-script')
    ...
    if ( $(this).hasClass('selected') ) {
        // Si hay al menos una fila seleccionada, habilita el botón
        table.button(0).enable(); // Habilita el primer botón (Editar)
    } else {
        // Si no hay filas seleccionadas, deshabilita el botón
        table.button(0).disable(); // Deshabilita el primer botón
    }
} );*/
