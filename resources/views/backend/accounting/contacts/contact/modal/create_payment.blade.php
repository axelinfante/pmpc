<form method="post" class="ajax-submit" autocomplete="off" action="{{ url('contacts/store_payment') }}" enctype="multipart/form-data" novalidate>
	{{ csrf_field() }}
	<div class="col-12">
		<div class="row">
			<div class="col-md-6">
		...
		<div class="col-md-6">
		  <div class="form-group">
			...
			<input type="text" class="form-control" name="razon_social" value="{{ old('razon_social',$contact->contact_name) }}" required>
		  </div>
		</div>
		  ...
		  <div class="form-group">
			...
			<div class="col-md-6">
			  <div class="form-group">
				...
				<input type="text" class="form-control float-field" value="{{($grand_total)}}" id="pending_amount" name="pending_amount" readOnly="true">
			  </div>
			</div>
			...
			<input type="hidden" name="payer_payee_id" value="{{ $contact->id }}">
			<input type="hidden" name="company_id" id="company_id" value="{{ $contact->company_id }}">
			<input type="hidden" name="imputar_a" id="imputar_a" value="{{ strtolower($contact->company->business_name) }}">
