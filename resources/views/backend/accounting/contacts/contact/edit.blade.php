						...
						<div class="row">
							...
							<div class="col-md-6">
							  <div class="form-group">
								...
								<input type="text" class="form-control" required name="vat_id" value="{{ $contact->dni_cuit ?? '' }}">
							  </div>
							</div>
							...
							<div class="col-md-6 d-none">
							  <div class="form-group">
								...
								<select class="form-control select2 " data-selected="{{ $contact->currency ?? '' }}"
								...
								<div class="form-group">
								  ...
								  <select name="estadoIva" class="form-control" id="estadoIva">
									...
									@foreach ($estadosIva as $iva )
										<option {{ (old('zip',$contact->estadoIva ?? '') == $iva) ? 'selected' : ''   }} value="{{ $iva }}">{{ $iva }}</option>
									@endforeach
								  </select>
								</div>
							  </div>
