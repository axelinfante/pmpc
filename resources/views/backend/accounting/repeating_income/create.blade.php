...
<div class="row">
	...
	<span class="d-none panel-title">{{ _lang('Add Repeating Income') }}</span>

	<div class="card-body">
	  <form method="post" class="validate" autocomplete="off" action="{{ url('repeating_income') }}" enctype="multipart/form-data">
		{{ csrf_field() }}
