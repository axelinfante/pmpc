                            ...
                            @if ($product->allCar != 1)
                                ...
                                <div class="col-md py-4">
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" id="mercado_libre" name="mercado_libre" class="form-check-input" {{ $product->mercado_libre==1 ? 'checked':'' }} value="1">
                                ...
                                @forelse($product->img as $img)
                                    <div class="card mx-3" style="width: 18rem;">
                                        <img class="card-img-top img-fluid"
											src="{{ marcaAgua(asset('public/uploads/products/'. $img->img),$img->company_id,'/products/'.$img->img) }}"   {{-- asset('public/uploads/products/' . $img->img) --}}
                                            alt="Card image cap">
                                        <div class="card-body">
                                    ...
                                    {{-- <div class="col-md-4"> --}}
                                    {{-- <img class="img-fluid img-thumbnail" src="{{asset('public/uploads/products/' --}}
                                    {{-- .$img->img)}}" --}}
                                    {{-- alt=""> --}}
                                    {{-- <div class="form-check"> --}}
                                    {{-- <input type="checkbox" class="form-check-input" name="imgDelete[]" --}}
