				...
				<table class="table table-bordered data-table">
					...
					<tbody>
						...
						<tr id="row_{{ $sales->id }}">
								...
								<td class='customer_id'>{{ $sales->customer->contact_name . " ( Cotización " . ($sales->venta->invoice_number ?? '') .")" }}</td>
								...
								<td class="text-center">
									...
									<div class="dropdown">
										...
										<a href="{{ action('SalesReturnController@show', $sales->id) }}" class="dropdown-item"><i class="fas fa-eye"></i> {{ _lang('View') }}</a>
										@if($sales->status == 'pendiente')
