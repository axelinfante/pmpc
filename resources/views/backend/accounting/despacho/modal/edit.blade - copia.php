            ...
            <div class="col-md-6">
				...
				<div class="form-group mb-4">
                        ...
                        <div class="invalid-feedback fw-bold">Please upload an image.</div>
								  ...
								  <input type="text" name="removed_files" />
...
function eliminarImagen() {
    ...
    this.on("errormultiple", function(files, response) {
      ...
      // Maybe show form again, and notify user of error
				  ...
				  @if(isset($imagenes))
				var files = {!! json_encode($imagenes) !!};
...
myDropzone.on("queuecomplete", function() {
    // Hide the modal here after all uploads are done
    // $('#uploadModal').modal('hide'); 
	alert(222);
});

/*	myDropzone.on("successmultiple", function(files, response) {
            // Handle successful form submission and file upload
