    ...
    <div class="row">
        ...
        {{-- <div class="col-md-8">
			<div class="form-group">
				...
				<textarea class="form-control" name="datos-titular" >{{ old('datos-titular') }}</textarea>
        ...
        {{-- <option value="">{{ _lang('Select One') }}</option> --}}
        {{-- <option value="0">{{ _lang('Explicar') }}</option> --}}
        {{-- <option value="1">{{ _lang('En fecha') }}</option> --}}
        ...
        <div class="field_wrapper my-5">
            ...
            <div class="form-group pb-2">
                ...
                <input type="text" class="form-control" name="otraPieza" value="" />
