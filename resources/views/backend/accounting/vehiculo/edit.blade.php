            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="post" class="ajax-submit" autocomplete="off"
                        action="{{ action('VehiculoController@update', $id) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} {{ $option }} id="company" name="company" required
                                        class="form-control">
                                        @foreach ($cias as $cia)
                                            <option
                                                {{ $car->company_id == $cia->id ? 'selected' : '' }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input {{ $option }} type="text" class="form-control" name="forma"
                                        value="{{ old('forma', $car->forma) }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} {{ $option }} class="form-control select2-ajax"
                                        data-value="id" data-display="nombre" data-table="aseguradoras" data-where=""
                                        name="idAseguradora" required>
                                        <option value="">{{ _lang('Select One') }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} {{ $option }} class="form-control" name="estado">
                                        ...
                                        @forelse($estados as $estado)
                                            <option {{ $estado->id == $car->idEstado ? 'selected' : '' }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} {{ $option }} class="form-control select2-ajax"
                                        data-value="id" data-display="marca" data-table="marcas" data-where=""
                                        id="marca">
                                        <option value="">{{ _lang('Select One') }}</option>
                                        @forelse($marcas as $marca)
                                            <option
                                                {{ $marca->id == ($car->marca_modelo->marca->id ?? '') ? 'selected' : '' }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <a href="{{ route('editModelo') }}" data-reload="false"
                                        data-title="{{ _lang('Update Modelo') }}" class="ajax-modal-2 select2-add"><i
                                            class="ti-plus"></i> {{ _lang('Updated') }}</a>
                                    ...
                                    <select {{ $option }} {{ $option }} class="form-control select2"
                                        ...
                                        @forelse($modelos as $modelo)
                                            <option
                                                {{ $modelo->id == ($car->marca_modelo->modelo->id ?? '') ? 'selected' : '' }}
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input {{ $option }} type="text" class="form-control"
                                        name="tramitador_compania"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} {{ $option }} class="form-control"
                                        name="tipo_baja">
                                        <option value="">{{ _lang('Select One') }}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lugar_retiro"
                                        value="{{ old('lugar_retiro', $car->lugar_retiro) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2-ajax"
                                        data-value="id" data-display="provincia" data-table="provincias" data-where=""
                                        name="provincia">
                                        <option value="">{{ _lang('Select One') }}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Fecha entrega 04 a asegurado') }} </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} class="form-control" name="entregado_a">
                                        ...
                                        @forelse($responsable_entregas as $key => $value)
                                            <option {{ $key == $car->entregado_a ? 'selected' : '' }}
                                                value="{{ $key }}">{{ $value }}</option>
                                        @empty
                                        @endforelse
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input {{ $option }} type="date" class="form-control"
                                        name="fecha_documento"
                                        value="{{ old('fecha_documento', $car->fecha_recepcion) }}">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">{{ _lang('Coordinar retiro') }} <input
                                            {{ $option }} type="checkbox" class="" name="coordinar_retiro"
                                            value="1"></label>

                                </div>
                                @if ($option != '')
                                    <div class="form-group">
                                        <label class="control-label">Avisar a tramitador <input type="checkbox"
                                                name="avisar_tramitador" value="1"></label>

                                    </div>
                                @endif

                                <div class="form-group">
                                    <label class="control-label">Retiro anticipado <input type="checkbox"
                                            name="retiro_anticipado" value="1"></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="fecha_retiro"
                                        value="{{ old('fecha_retiro', $car->fecha_retiro) }}">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <a href="{{ route('staffs.create') }}" data-reload="false"
                                        data-title="{{ _lang('Create Transportista') }}"
                                        class="ajax-modal-2 select2-add"><i class="ti-plus"></i>
                                        {{ _lang('Add New') }}</a>
                                    <label class="control-label">{{ _lang('Transportista') }}</label>
                                    <select {{ $option }} class="form-control select2-ajax" data-value="users.id"
                                        data-display="users.name" data-table="users" data-where="6" name="retira">
                                        <option value="">{{ _lang('Select One') }}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} class="form-control" name="lugar_entregas">
                                        <option value="">{{ _lang('Select One') }}</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input {{ $option }} type="date" class="form-control" name="fecha_ingreso"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select {{ $option }} class="form-control" name="control">
                                        <option value="">{{ _lang('Select One') }}</option>
                                        <option {{ $car->control == 0 ? 'selected' : '' }} value="0">
                                            {{ _lang('Explicar') }}</option>
                                        <option {{ $car->control == 1 ? 'selected' : '' }} value="1">
                                            {{ _lang('En fecha') }}</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="observacion_retiro">{!! old('observacion_retiro', strip_tags($car->observacion_retiro)) !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div>
                                    <select {{ $option }} class="select2 form-control" multiple name="piezasAu[]">
                                ...
                                <div class=" form-group pb-2">
                                    ...
                                    <input {{ $option }} type="text" class="form-control" name="otraPieza"
                                        value="" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input {{ $option }} type="file" accept="video/*" name="video" />
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="imagen">Fotos</label>
                                <input {{ $option }} type="file" class="form-control" id="imagen[]"
                                    name="imagen[]" multiple="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label">Notificar carga de imagenes <input type="checkbox"
                        ...
                        @forelse($car->img as $img)
                            <div class="card mx-3" style="width: 18rem;">
                                <img class="card-img-top img-fluid"
                                    src="{{ asset('public/uploads/vehiculos/' . $img->img) }}" alt="Card image cap">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <div class="form-check">
                                        <input {{ $option }} type="checkbox" class="form-check-input"
                                            name="imgDelete[]" value="{{ $img->id }}">
