                ...
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="panel-title">
                            ...
                            {{ _lang('Ingreso Manual a Cuenta Corriente') }}
                        </h4>
                        <p class="mb-0">
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="alert alert-info">
                            ...
                            <p class="mb-0"><small><i class="fas fa-info-circle"></i> Un ingreso manual aumenta el saldo del cliente en la cuenta corriente y también ingresa dinero a la cuenta bancaria seleccionada.</small></p>
                        </div>
                    </div>
                </div>

                <form method="post" autocomplete="off" action="{{ route('cuenta_corriente.ingreso.store') }}?id={{ $id }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label class="control-label">Cuenta Bancaria (Donde ingresa el dinero)</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label class="control-label">{{ _lang('Rubro de Ingreso') }} <small class="text-muted">(Opcional)</small></label>
                                <select class="form-control select2-ajax" data-value="id" data-display="name" data-table="chart_of_accounts" data-where="3" name="chart_id">
                                    <option value="">{{ _lang('Select One - Si no selecciona, se usará "Ingreso de Cliente"') }}</option>
                                    @foreach($charts as $chart)
                                    <option value="{{ $chart->id }}" {{ old('chart_id') == $chart->id ? 'selected' : '' }}>{{ $chart->name }}</option>
                                    @endforeach
                                </select>
                                <small class="form-text text-muted">Si no selecciona un rubro, se usará automáticamente "Ingreso de Cliente".</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" id="tasa_container" style="display: none;">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Solo necesario cuando se ingresa en USD</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="razon_social" value="{{ old('razon_social') }}" placeholder="Razón social o nombre del depositante" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Monto a ingresar a la cuenta del cliente</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cheque_entregado_a" value="{{ old('cheque_entregado_a') }}" placeholder="Persona que entregó el cheque">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="note" rows="2" placeholder="Descripción del ingreso">{{ old('note', 'Ingreso manual a cuenta corriente') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary">{{ _lang('Ingresar Dinero a la Cuenta') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
