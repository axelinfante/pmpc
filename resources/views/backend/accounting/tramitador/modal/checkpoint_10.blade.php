    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label">{{ _lang('Fecha de inicio') }} </label>
                <input required type="date" class="form-control" name="fecha_inicio_preinforme"
                    value="{{$car->fecha_inicio_preinforme}}" >
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label">{{ _lang('Fecha de finalización') }} </label>
                <input type="date" class="form-control" name="fecha_finalizacion_preinforme"
                    value="{{$car->fecha_finalizacion_preinforme}}" >
            </div>
        </div>
        <div class="col-md-12">
            <div class="form-group">
