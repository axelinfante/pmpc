    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label class="control-label">{{ _lang('Fecha de baja enviada por email') }} </label>
                <input required type="date" class="form-control" name="fecha_envio_baja"
                 value="{{$car->fecha_envio_baja}}">
            </div>
        </div>
