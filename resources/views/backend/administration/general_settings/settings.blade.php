    ...
    <div class="row">
          <div class="col-sm-3">
			  <ul class="nav flex-column nav-tabs settings-tab" role="tablist">
				  ...
				  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#recaptcha">{{ _lang('Google Recaptcha') }}</a></li>
			  ...
			  <div class="tab-content">
				  ...
				  <div id="email" class="tab-pane fade">
					<div class="card">
					 ...
					 <div class="card mt-4">
						<div class="card-body">
							<h4 class="mb-4 header-title panel-title">{{ _lang('Send Test Email') }}</h4>
							<form action="{{ route('settings.send_test_email') }}" class="appsvan-submit params-panel" method="post">
								<div class="row">
									@csrf
									<div class="col-md-12">
										<div class="form-group">
									...
									<div class="col-md-12">
										<div class="form-group">
											<button type="submit" class="btn btn-primary">{{ _lang('Send Test Email') }}</button>
										</div>
									</div>
								</div>
							</form>
				 ...
				 <div id="recaptcha" class="tab-pane fade">
					<div class="card">
						<div class="card-body">
							<h4 class="mb-4 header-title panel-title">{{ _lang('GOOGLE RECAPTCHA V2') }}</h4>
							<form method="post" class="appsvan-submit params-panel" autocomplete="off" action="{{ url('administration/general_settings/update') }}" enctype="multipart/form-data">
								{{ csrf_field() }}
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">{{ _lang('Google Recaptcha') }}</label>
											<select class="form-control select2" name="google_recaptcha" required>
												<option value="disabled" {{ get_option('google_recaptcha') == 'disabled' ? 'selected' : '' }}>{{ _lang('Disable') }}</option>
												<option value="enabled" {{ get_option('google_recaptcha') == 'enabled' ? 'selected' : '' }}>{{ _lang('Enable') }}</option>
											</select>
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">{{ _lang('RECAPTCHA SITE KEY') }}</label>
											<input type="text" class="form-control" name="RECAPTCHA_SITE_KEY" value="{{ get_option('RECAPTCHA_SITE_KEY') }}">
										</div>
									</div>

									<div class="col-md-6">
										<div class="form-group">
											<label class="control-label">{{ _lang('RECAPTCHA SECRET KEY') }}</label>
											<input type="text" class="form-control" name="RECAPTCHA_SECRET_KEY" value="{{ get_option('RECAPTCHA_SECRET_KEY') }}">
										</div>
									</div>
