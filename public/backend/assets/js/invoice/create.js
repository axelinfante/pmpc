        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (service.prop('id') == 'service') {
                    ...
                    $('#car_id').data('company', product['company_id']);
                    $('#company_id').val(product['company_id']);
                    $('#company_id_s').val(product['company_id']);
                }
                //console.log(service);
                ...
                if (product.marca_modelo) {
                    ...
                    modelo = product.marca_modelo.modelo.modelo;
                }

				// si la pieza es desarmada
				let desarmar_actualitem=$('#desamar_item').val();
				$('#desamar_item').val("");
                ...
                var product_row = `<tr id="product-${product['id']}">
											...
											<td class="text-right unit-cost"><input type="text" data-id="${product['id']}" onChange="monto_en_usd(this,${product['id']})" name="unit_cost[]" class="form-control input-unit-cost text-right" value="${unit_cost.toFixed(2)}"></td>
											...
											<input type="hidden" name="desarmar_id[]" value="${desarmar_actualitem}">
